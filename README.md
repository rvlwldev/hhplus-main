...
- [x] 엔티티 구현 및 기본적인 조회/저장 구현
  - 유저 포인트 충전/사용, 콘서트 및 콘서트별 일자, 잔여 좌석 등 조회
- [x] 토큰 기반 대기열 처리 구현 및 Polling
- [x] 임시 배정 및 잔여석 표시 구현 및 테스트

#### M5 (5주차)

- [x] 콘서트 결제 기능 구현 (동시성 처리)
  - [x] 사용자 포인트에 대한 예외 처리 포함
  - [x] 임시 배정 상태 등 데이터 정합성 처리 포함
- [x] E2E 테스트 및 예외처리
